# Workflow: workflow_edited --> ionquant = false (in pfragpipes workflow its set to true)

# Please edit the following path to point to the correct location.
# In Windows, please replace single '\' with '\\'

# database.db-path=__FASTA__ is added during workflow process
...
msbooster.rt-model=Prosit_2019_irt
msbooster.run-msbooster=true
msbooster.spectra-model=Prosit_2020_intensity_HCD
...
phi-report.filter=--sequential --prot 0.01 --psm 0.01 --pep 0.01 --picked
